          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-body printableArea">
                <h3><b>Date Range:</b> <span class="pull-right"><?=date('m/d/Y',strtotime($startdate));?> to <?=date('m/d/Y',strtotime($enddate));?></span></h3>
                <hr />
                <div class="row">                  
                  <div class="col-md-12">
                    <div class="table-responsive" style="clear: both">
                      <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            $refund=0;
                            $check=$this->Ordering_model->db->query("SELECT SUM(amount) as refund FROM sales WHERE remarks='Refund' AND datearray BETWEEN '$startdate' AND '$enddate' GROUP BY remarks");
                            if($check->num_rows() > 0){
                                $res=$check->row_array();
                                $refund=$res['refund'];                                
                            }                
