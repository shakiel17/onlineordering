            ...
            <div class="auth-box bg-light border-top border-secondary">
                <div id="loginform">
                    ...
                    <span class="db"><img src="<?=base_url();?>design/assets/images/onlineorderinglogo.png" alt="logo" width="100" /></span><br>
                        <font style="font-size:20px;"><b>User Login</b></font>
                    </div>
                    <!-- Form -->
                    <?php
                    ...
                    ?>
                    <?=form_open(base_url()."user_authentication",array('class' => 'form-horizontal m-t-20','id' => 'loginform'));?>
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button class="btn btn-info" id="to-recover" type="button"><i class="fa fa-lock m-r-5"></i> Not yet a member?</button>
                                        <a href="<?=base_url();?>" class="btn btn-warning" id="to-recover"><i class="fa fa-home"></i></a>
                ...
                <div class="text-center p-t-20 p-b-20">
                    <span class="db"><img src="<?=base_url();?>design/assets/images/onlineorderinglogo.png" alt="logo" width="100" /></span><br>
                        <font style="font-size:20px;"><b>User Registration</b></font>
                    </div>
                    <div>
                        <!-- Form -->
                        <?=form_open(base_url()."user_registration",array('class' => 'form-horizontal m-t-20','id' => 'loginform'));?>
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-warning text-white" id="basic-addon1"><i class="fas fa-phone"></i></span>
                                    </div>
                                    <input type="text" name="contactno" class="form-control form-control-lg" placeholder="Contact No" aria-label="Username" aria-describedby="basic-addon1" required>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-danger text-white" id="basic-addon1"><i class="ti-home"></i></span>
                                    </div>
                                    <textarea class="form-control form-control-lg" placeholder="Address" name="address" rows="3"></textarea>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-success text-white" id="basic-addon1"><i class="ti-user"></i></span>
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button class="btn btn-block btn-info" type="submit">Sign Up</button>
                                        <a href="<?=base_url();?>user_login" class="btn btn-block btn-success">Login</a>
                                        <a href="<?=base_url();?>" class="btn btn-block btn-warning">Home</a>
                                    </div>
                                </div>
                            </div>
                        </div>
